...
/*handleAddTwoScheduleVisible = flag => {
  this.setState({
    TwoschduleAddVisible: !!flag,
  });
};*/

/*const TwoschduleAdd = {
  handleAdd: this.handleAdd,
  handleAddTwoScheduleVisible: this.handleAddTwoScheduleVisible,
};*/
...
export default class CalendarAll extends PureComponent {
  ...
  state = { TwoschduleAddVisible :false };

  render() {
    const  {TwoschduleAddVisible} = this.state;
    return (
      <PageHeaderLayout>
        <Card>
 ...
 {/* <AddSchedule  {...TwoschduleAdd} TwoschduleAddVisible = {TwoschduleAddVisible} />*/}
      </PageHeaderLayout>
    );
  }
}
