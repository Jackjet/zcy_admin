...
class ExampleTable extends React.Component {
  ...
  render() {
    const columns = [
     ...
     //     return <a href="#" name="delete" onClick={function() { this.showCurRowMessage(record)}} >信息</a>; } },
      // 精简写法
      { title: '操作', dataIndex: '', key: 'operation', render: (text, record, index) => <a href="#" name="delete" onClick={() => this.showCurRowMessage(record)}>信息</a> },
    ];
