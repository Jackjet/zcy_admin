...
const AddContract = Form.create()(props => {
...
const EditContract = Form.create()(props => {
  const { editContractVisible, handleEditContractVisible } = props;
  const okHandle = () => {
    handleEditContractVisible();
  };
  ...
  return (
    <Modal
      ...
      maskClosable={false}
      onOk={okHandle}
      onCancel={() => handleEditContractVisible()}
    >
      <ContractAdd />
    </Modal>
  );
...
const ViewContractTabs = Form.create()(props => {
...
@Form.create()
export default class ContractForProject extends PureComponent {
  state = {
    modalVisible: false,
  ...
  handleEditContractVisible = flag => {
    this.setState({
      editContractVisible: !!flag,
    });
  };
  ...
  render() {
    ...
    const { selectedRows, modalVisible, checkContractVisible, editContractVisible } = this.state;
    ...
    const parentMethods = {
      ...
      handleEditContractVisible: this.handleEditContractVisible,
    };
    ...
    return (
      <div>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListOperator}>
              ...
              <Button type="primary" onClick={() => this.handleEditContractVisible(true)}>
                编辑合同
              </Button>
              <Divider type="vertical" />
        ...
        <AddContract {...parentMethods} modalVisible={modalVisible} />
        <EditContract {...parentMethods} editContractVisible={editContractVisible} />
        <ViewContractTabs {...parentMethods} checkContractVisible={checkContractVisible} />
      </div>
    );
  }
}
