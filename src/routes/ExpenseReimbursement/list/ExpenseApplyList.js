...
@Form.create()
export default class ExpenseApplyList extends PureComponent {
  state = {
    // 客户增加状态
    customerAddVisible: false,

    // 申请单
    expenseApplyAddVisible: false,
  ...
  handleExpenseApplyAddVisible = flag => {
    this.setState({
      expenseApplyAddVisible: !!flag,
    });
  };
  handleReimbursementListAddVisible = flag => {
    this.setState({
  ...
  render() {
    ...
    const ExpenseApplyAddMethods = {
      handleExpenseApplyAddVisible: this.handleExpenseApplyAddVisible,
    };
    const ReimbursementListAddMethods = {
      handleReimbursementListAddVisible: this.handleReimbursementListAddVisible,
    };
