...
import { Card, Form, Col, Row, Input, Select, DatePicker, Transfer, Modal, Icon, message } from 'antd';
...
class VisitListAddModal extends PureComponent {
  ...
  render() {
    const { form, dispatch, submitting, visitVisible, handleVisitVisible } = this.props;
