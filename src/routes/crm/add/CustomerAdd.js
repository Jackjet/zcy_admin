            ...
            <Row className={styles['row-h']}>
              ...
              <Col span={16}>
                <Form.Item {...addresscol} label={fieldLabels.address}>
                  ...
                  })(<Input placeholder="请输入详细地址" style={{ width: 580 }} />)}
                </Form.Item>
              </Col>
            </Row>
            <Row className={styles['row-h']}>
              ...
              <Col span={16}>
                <Form.Item {...remarkcol} label={fieldLabels.remark}>
                  ...
                  })(<Input placeholder="请输入备注" style={{ width: 580 }} />)}
                </Form.Item>
              </Col>
            </Row>
            <Row className={styles['row-h']}>
              ...
              <Col span={16}>
                <Form.Item {...companycol} label={fieldLabels.company}>
                  {getFieldDecorator('company', {})(
                    <Input placeholder="所属公司" style={{ width: 580 }} />
                  )}
                </Form.Item>
              </Col>
            </Row>
            <Row gutter={24} className={styles.footer}>
              <Col span={24} style={{ overflow: 'hidden', textAlign: 'center' }}>
                <span style={{ marginBottom: 24 }}>
                  ...
                  <Button style={{ marginLeft: 8, width: '100px' }}>取消</Button>
                </span>
              </Col>
            </Row>
          </Form>
