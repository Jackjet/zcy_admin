...
import DemoModalArchives from './DemoModalArchives';
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
          <Fragment>
            <a onClick={() => this.handleCusApplyViewVisible(true, record)}>归档完成</a>
          </Fragment>
        ),
      },
    ];
    ...
    return (
      <PageHeaderLayout>
              ...
              <div>
                <div className={styles.tableList}>
                  <Radio.Group >
                    ...
                    <Radio.Button>已归档</Radio.Button>
                    <Radio.Button>未归档</Radio.Button>
                  </Radio.Group>
                  <StandardTable
       ...
       {/* <CustomerApplyAddModal {...parentMethods} cusApplyAddVisible={cusApplyAddVisible} linkmanOptionData={linkmanOptionData} />
        ...
        <DemoModalArchives {...parentMethods} visitAddVisible={visitAddVisible} />
