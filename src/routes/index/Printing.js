...
@Form.create()
export default class Printing extends PureComponent {
  state = {
  ...
  handleVisitAddVisible = (flag, record) => {
    this.setState({
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
          <Fragment>
            <a onClick={() => this.handleCusApplyViewVisible(true, record)}>打印完成</a>
            <Divider type="vertical" />
            <a onClick={() => this.handleCusApplyEditVisible(true, record)}>装订完成</a>
          </Fragment>
        ),
      },
    ];
    ...
    return (
      <PageHeaderLayout>
              ...
              <div>
                <div className={styles.tableList}>
                  <Radio.Group >
                    ...
                    <Radio.Button>打印未装订</Radio.Button>
                    <Radio.Button>未打印</Radio.Button>
                  </Radio.Group>
                  <StandardTable
                    ...
                    onRow={(record) => {  // 表格行点击事件
                      return {
                        onDoubleClick: () => {
                          this.handleVisitAddVisible(true, record)
                        },
                      };
                    }}
                  />
        ...
        <DemoModal {...parentMethods} visitAddVisible={visitAddVisible} rowInfo={rowInfo} />
