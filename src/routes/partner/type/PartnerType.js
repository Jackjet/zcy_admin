...
import styles from './PartnerType.less';
import PartnerTypeAdd from './PartnerTypeAdd';
...
export default class PartnerTypeTableList extends PureComponent {
  state = {
    modalVisible: false,
    selectedRows: [],
    formValues: {},
  ...
  render() {
    ...
    return (
      <PageHeaderLayout>
        ...
        <PartnerTypeAdd {...parentMethods} modalVisible={modalVisible} />
      </PageHeaderLayout>
    );
  }
}
