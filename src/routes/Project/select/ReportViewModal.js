...
class ReportViewModal extends PureComponent {
  state = {
    width: '100%',
  };
  componentDidMount() {
  ...
  render() {
    const { form, dispatch, submitting, reportViewVisible, handleReportViewVisible, rowInfoCurrent } = this.props;
