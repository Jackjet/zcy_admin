...
import { Layout, Icon, message,Modal, Button,Radio, Menu } from 'antd';
...
import { getProMenuData } from '../common/menuPro';
...
getProMenuData().forEach(getRedirect);
...
class BasicLayout extends React.PureComponent {
  ...
  handleMenuClickToChangeMenu = e => {
    switch (e.key) {
      case 'center':
        ...
        console.log("cente" + this.state.MenuData);
       /* this.props.dispatch(routerRedux.push('/'));*/
        break;
      case 'pro':
        console.log("pro");
        ...
        console.log("pro" + this.state.MenuData);
        this.getChildContext();
        /*this.props.dispatch(routerRedux.push('/'));*/
        break;
      default:
  ...
  render() {
    const { switchOrgvisible,userInfovisible, loading, MenuData } = this.state;
    const {
      currentUser,
      collapsed,
      fetchingNotices,
        ...
        <Layout>
          <Header style={{padding: 0}}>
            <GlobalHeader
              ...
              handleMenuClick={this.handleMenuClickToChangeMenu}
            />
          </Header>
          ...
          <Footer style={{ padding: 0 }}>
            <GlobalFooter
              ...
              copyright={
                <Fragment>
                  Copyright <Icon type="copyright" /> 2018-2018 杭州至诚云软件技术有限公司版权所有
